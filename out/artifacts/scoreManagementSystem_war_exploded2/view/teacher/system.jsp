                ...
                <ul class="layui-nav layui-nav-tree layui-inline" lay-filter="test" lay-shrink="all">
                    ...
                    <li class="layui-nav-item">
                        <a href="javascript:void(0);" id="home"
                           url="${pageContext.request.contextPath}/view/teacher/welcome.jsp">主页</a>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;">个人信息</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:void(0);" url="TeacherServlet?method=toInfoView">个人信息查看</a>
                            </dd>
                            <dd><a href="javascript:void(0);" url="TeacherServlet?method=toEditPWView">修改密码</a>
                            </dd>
                        </dl>
                    </li>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:void(0);" url="TeacherServlet?method=toScoreInfoView">成绩查看</a></dd>
                        </dl>
                    </li>
