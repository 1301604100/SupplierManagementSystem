        ...
        <div id="Dialog" style="padding: 10px">
            <form id="Form" method="post" name="from" class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 50px">教师号:</label>
                    <div class="layui-input-block">
                        <input id="edit_number" type="number" name="number" placeholder="请输入教师号" autocomplete="off"
        ...
        <script>
            layui.use('form', function () {
                ...
                form.on('submit(*)', function (data) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "http://localhost:8080/TeacherListServlet?method=EditTeacher",
                        data: $("#Form").serialize(),
                        success: function (msg) {
                            if (msg === "success") {
                                layer.msg('修改成功!');
                            } else if (msg === "exist") {
                                layer.msg('已存在该教师!,修改失败');
                            }
                        }
                    })
